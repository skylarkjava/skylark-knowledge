...
<link rel="stylesheet" href="<%= request.getContextPath() %>/bower/codemirror/lib/codemirror.css" />
...
<link rel="stylesheet" href="<%= jspUtil.mustReloadFile("/css/uikit.docs.min.css") %>" />
</c:param>
...
<script type="text/javascript" src="<%= request.getContextPath() %>/bower/codemirror/lib/codemirror.js"></script>
<script type="text/javascript" src="<%= request.getContextPath() %>/bower/marked/marked.min.js"></script>
<script type="text/javascript" src="<%= request.getContextPath() %>/bower/to-markdown/dist/to-markdown.js"></script>
...
<script type="text/javascript" src="<%= jspUtil.mustReloadFile("/js/jquery.easyeditor.js") %>"></script>
<script type="text/javascript" src="<%= jspUtil.mustReloadFile("/js/htmleditor.js") %>"></script>
...
<h4 class="title row" id="title_msg"><%= jspUtil.label("knowledge.edit.title") %></h4>
<form action="<%= request.getContextPath()%>/protect.entry/update" method="post" role="form" id="knowledgeForm" enctype="multipart/form-data">
	<!-- info -->
	...
	<c:import url="/WEB-INF/views/commons/category/category_list.jsp">
		<c:param name="PARAM_SHOW_CATEGORY_LABEL" value="true"/>
	</c:import>

	<!-- template -->
	<div class="form-group row ${templates.size() ==1 ? 'hide':''} ">
		...
		<div class="alert alert-info hide row" role="alert" id="template_info">
	...
	<!-- items -->
	<div class="form-group row" id="template_items">
	</div>
	...
	<div class="form-group row">
		...
		<textarea class="form-control" data-uk-htmleditor="{mode:'tab',markdown:true}" name="content" rows="8" placeholder="<%= jspUtil.label("knowledge.add.label.content") %>" id="content"><%= jspUtil.out("content") %></textarea>
	...
	<div class="form-group row" id="drop_target">
		<%= jspUtil.label("knowledge.add.label.area.upload") %>
	</div>
	<div class="form-group row" style="display: none;" id="progress">
		<div class="progress">
	...
	<div class="form-group row" id="grops_area" <%= jspUtil.isnot(KnowledgeLogic.PUBLIC_FLAG_PROTECT, "publicFlag", "style=\"display: none;\"") %>>
	...
	<!-- editors -->
	<div class="form-group row" id="editor_area">
...
<form action="<%= request.getContextPath()%>/protect.entry/delete" method="post" role="form" id="knowledgeDeleteForm">
