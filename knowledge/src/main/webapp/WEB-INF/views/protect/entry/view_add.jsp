...
<h4 class="title row" id="title_msg"><%= jspUtil.label("knowledge.add.title") %></h4>

<form action="<%= request.getContextPath()%>/protect.entry/add" method="post" role="form" enctype="multipart/form-data" id="knowledgeForm">
	...
	<div class="form-group row">
		...
		<textarea data-uk-htmleditor="{mode:'tab',markdown:true}" class="form-control" name="content" rows="8" placeholder="<%= jspUtil.label("knowledge.add.label.content") %>" id="content"><%= jspUtil.out("content") %></textarea>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div role="form" class="form-inline">
					...
					<span class="span1" style="font-size: 14px;" id="groupPage"></span>
