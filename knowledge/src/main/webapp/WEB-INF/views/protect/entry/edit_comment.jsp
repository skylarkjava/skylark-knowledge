...
<form action="<%= request.getContextPath()%>/protect.entry/update_comment" method="post" role="form" id="commentForm" enctype="multipart/form-data">
	...
	<a href="<%= request.getContextPath()%>/protect.entry/view/<%= jspUtil.out("knowledgeId") %>" class="btn btn-warning">
