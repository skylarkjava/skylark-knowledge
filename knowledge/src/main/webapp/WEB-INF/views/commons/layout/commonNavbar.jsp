	...
	<div class="container">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand"
				...
				style="cursor: pointer;"> <i class="fa fa-book"></i>&nbsp;<%=jspUtil.labelNlsText("knowledge.navbar.title",systemText,entryText) %>
			</a>
		</div>
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="navButton navAddButton">
					<a href="<%= request.getContextPath() %>/protect.entry/view_add<%= jspUtil.out("params") %>" style="cursor: pointer;"
						id="navAddButtonLink">
						<i class="fa fa-plus-circle"></i>&nbsp;<%= jspUtil.label("knowledge.navbar.add.knowledge") %>
					</a>
				</li>
				<li class="navButton navListButton">
					<a href="<%= request.getContextPath() %>/open.entry/list" style="cursor: pointer;"
				...
				<li class="dropdown navButton navMenuButton">
					...
					<ul class="dropdown-menu" role="menu">
						<li >
							<a href="<%= request.getContextPath() %>/open.entry/search" >
