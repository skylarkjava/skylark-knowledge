...
public class LuceneSearcher implements Searcher {
	...
	public static final String FIELD_LABEL_CATEGORY = LuceneIndexer.FIELD_LABEL_CATEGORY;
...
//	private Analyzer analyzer = new SimpleAnalyzer(Version.LUCENE_4_10_2);
	...
	private Query structQuery(final SearchingValue value) throws ParseException {
		...
		if (value.getCategory()!=null){
			Query query = NumericRangeQuery.newIntRange(FIELD_LABEL_CATEGORY, 1, value.getCategory(), value.getCategory(), true, true);
			container.add(query, BooleanClause.Occur.MUST);
		}
