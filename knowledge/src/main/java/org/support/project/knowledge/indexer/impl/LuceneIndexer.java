...
public class LuceneIndexer implements Indexer {
	...
	public static final String FIELD_LABEL_CATEGORY = "category";
...
//	private Analyzer analyzer = new SimpleAnalyzer(Version.LUCENE_4_10_2);
	...
	private void addDoc(IndexWriter writer, IndexingValue indexingValue) throws Exception {
		...
		//category
		if (indexingValue.getCategory() != null) {
			Field categoryField = new IntField(FIELD_LABEL_CATEGORY, indexingValue.getCategory(), Field.Store.YES);
