...
public class MailLogic {
	...
	public void sendInvitation(ProvisionalRegistrationsEntity entity, String url, Locale locale) {
		...
		title = title.replace("{SystemName}", syscfg.getSystemText());
		title = title.replace("{EntryText}", syscfg.getEntryText());
		mailsEntity.setTitle(title);

		String contents = mailConfig.getContents();
		contents = contents.replace("{SystemName}", syscfg.getSystemText());
		contents = contents.replace("{EntryText}", syscfg.getEntryText());
