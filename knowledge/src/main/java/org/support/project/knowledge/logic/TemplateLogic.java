...
public class TemplateLogic {
	...
	public static final int ITEM_TYPE_CENTERAPP = 20;
	public static final int ITEM_TYPE_LOCALAPP = 21;
	...
	public static final String ITEM_TYPE_CENTERAPP_STRING = "centerapp";
	public static final String ITEM_TYPE_LOCALAPP_STRING = "localapp";
	...
	public int convType(String type) {
		...
		} else if (ITEM_TYPE_CENTERAPP_STRING.equals(type)) {
			return ITEM_TYPE_CENTERAPP;
		} else if (ITEM_TYPE_LOCALAPP_STRING.equals(type)) {
			return ITEM_TYPE_LOCALAPP;
		}
	...
	public String convType(int type) {
		...
		} else if (ITEM_TYPE_CENTERAPP == type) {
			return ITEM_TYPE_CENTERAPP_STRING;
		} else if (ITEM_TYPE_LOCALAPP == type) {
			return ITEM_TYPE_LOCALAPP_STRING;
		}
		LOG.warn("Item type: " + type + " is undefined.");
		return "";
	}
