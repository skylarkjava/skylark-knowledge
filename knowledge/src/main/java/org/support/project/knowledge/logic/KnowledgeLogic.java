...
public class KnowledgeLogic {
	...
	private void saveIndex(KnowledgesEntity entity, List<TagsEntity> tags, List<LabelValue> targets,
		...
		indexingValue.setCategory(entity.getCategoryId());
	...
	private List<KnowledgesEntity> searchKnowledge(SearchingValue searchingValue) throws Exception {
		...
		List<KnowledgesEntity> result = getKnowledgeDatas(searchingValue,list);
	 ...
	 * @throws Exception
	 */
	public List<KnowledgesEntity> searchKnowledge(Integer category,String keyword, List<TagsEntity> tags,
		...
		searchingValue.setCategory(category);
	...
	public List<KnowledgesEntity> searchKnowledge(String keyword, LoginedUser loginedUser, Integer offset, Integer limit) throws Exception {
		return searchKnowledge(null,keyword, null, null, loginedUser, offset, limit);
	}
	 ...
	 * @throws Exception
	 */
	public List<KnowledgesEntity> showKnowledgeOnTag(Integer category,String tag, LoginedUser loginedUser, Integer offset, Integer limit) throws Exception {
		SearchingValue searchingValue = new SearchingValue();
		searchingValue.setOffset(offset);
		searchingValue.setLimit(limit);
	 ...
	 * @throws Exception
	 */
	public List<KnowledgesEntity> showKnowledgeOnGroup(Integer category,String group, LoginedUser loginedUser, Integer offset, Integer limit) throws Exception {
	 ...
	 * @return
	 */
	private List<KnowledgesEntity> getKnowledgeDatas(SearchingValue searchingValue,List<SearchResultValue> list) {
...
//				fileIds.add(new Long(id));
		...
		for (KnowledgesEntity knowledgesEntity : dbs) {
			if (searchingValue.getCategory()!=null && !searchingValue.getCategory().equals(knowledgesEntity.getCategoryId())){
				continue;
			}
...
//	}
	 ...
	 * @return
	 */
	public List<KnowledgesEntity> getKnowledges(Integer categoryId, List<String> ids, LoginedUser loginedUser) {
