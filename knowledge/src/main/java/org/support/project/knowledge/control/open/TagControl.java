...
public class TagControl extends Control {
	...
	public Boundary list() throws InvalidParamException {
		...
		List<TagsEntity> tags = TagLogic.get().selectTagsWithCount(null,super.getLoginedUser(), offset * LIST_LIMIT, LIST_LIMIT);
	...
	public Boundary json() throws InvalidParamException {
		...
		List<TagsEntity> tags = TagsDao.get().selectWithKnowledgeCountOnTagName(null,keyword, offset * limit, limit);
		return send(tags);
	}
