...
public class SystemConfig {
	...
	/** システム表示名のシステム設定のラベル */
	public static final String SYSTEM_NAME_EXTERNAL = "SYSTEM_NAME_EXTERNAL";

	public static final String SYSTEM_NAME_EXTERNAL_INITVAL = "[Your System Name]";

	/** エントリ名のシステム設定のラベル */
	public static final String SYSTEM_ENTRY_TEXT = "ENTRY_TEXT";

	public static final String SYSTEM_ENTRY_TEXT_INITVAL = "[Entry Text OF Your System]";

	public static final String SYSTEM_SLOGAN_TEXT = "SLOGAN_TEXT";

	public static final String SYSTEM_SLOGAN_TEXT_INITVAL = "[ Slogan Text Of Your System]";
	...
	/** Cookieにセットする際のキー：カテゴリ */
	public static final String COOKIE_KEY_CATEGORY = "CATEGORY";
